    ...
    <>
      ...
      <SectionContainer withoutAnimation={true}>
        <Stack>
          ...
          <DocItem>Financial Freedom Fighters, Inc. d/b/a paraplanner.ai (“paraplanner.ai”, “we”, “us” or “our”) is committed to respecting your privacy.  This Privacy Policy explains our practices regarding the collection, use, and disclosure of information that you (“you” or “user”) may provide to us through your use of our website at <a href="https://www.paraplanner.ai" target="_blank">https://www.paraplanner.ai</a> (the “Website”) and all of its sub-domains, the platform at <a href="https://app.paraplanner.ai" target="_blank">https://app.paraplanner.ai</a>, which we also make available through the Website (the “Platform”), and any related services, social media pages and apps  (the Website and Platform, together with any related services, social media pages and apps, are collectively referred to as our “Services”). </DocItem>
          <DocItem>By visiting, accessing and/or using our Services you agree to be bound by this Privacy Policy.  If you do not agree to the terms of this Privacy Policy, please do not use the Services.  Each time you use the Services, the current versions of this Privacy Policy will apply.  </DocItem>



          <DocHeader>INFORMATION WE COLLECT AND HOW WE USE IT</DocHeader>
          <DocItem>We collect two types of information from users of our Services: “Personal Information,” which is information that can be used to identify you (such as your name or your email address), and “Aggregate Information,” which is information that cannot be used to identify you (such as frequency of visits to the Website and Platform or your browser type).</DocItem>
          <DocHeader>INFORMATION YOU PROVIDE TO US</DocHeader>
          <DocItem>We collect Personal Information that you voluntarily provide to us when you use our Services.  For example, you may provide us with your contact information, your name, the content of your communication, or other Personal Information when you choose to send it to us through email, an online form, when engaging with our conversational artificial intelligence tools, or other method.   If you interact with us on social media, we may collect your social media profile information, your communications with us, and your communications and posts on our social media pages.</DocItem>
          ...
          <DocHeader>AGGREGATE INFORMATION COLLECTED</DocHeader>
          <DocItem>Aggregate Information is information that does not identify you.  Aggregate Information may be collected when you use our Services, independent of any information you voluntarily enter. Additionally, we may use one or more processes to de-identify information that contains Personal Information, such that only Aggregate Information remains.  We may collect, use, store, and transfer Aggregate Information without restriction (subject to applicable law).</DocItem>

          <DocHeader>COOKIES AND ANALYTICS</DocHeader>
          <DocItem sx={{ marginBottom: 0 }}>
          ...
          <DocHeader>HOW WE SHARE YOUR INFORMATION</DocHeader>
          <DocItem><b><i>We do not rent or sell your Personal Information.</i></b></DocItem>
          <DocItem>We share information, including Personal Information, in certain circumstances with third parties through operation of our Services.  Below we explain when that happens.  We also disclose information and Personal Information when required by applicable law.</DocItem>


          <DocHeader>SERVICE PROVIDERS</DocHeader>
          <DocItem>We may transfer Personal Information to third parties for the purpose of providing the Services or operating our business.  For example, we may transfer your Personal Information to non-affiliated third-party service providers to assist with providing the Platform, to enable certain artificial intelligence functionality layers (“AI Enablement”) within the Platform, or to communicate with you.</DocItem>
          <DocItem sx={{ marginBottom: 0 }}>
          ...
          <DocItem>By using our Services, you acknowledge and agree to GPT-4’s terms and conditions, and that any use, storage or processing of Provided Data and other information provided by you  shall be subject to GPT-4’s policies,  We will use commercially reasonable efforts to identify any changes to our AI Enablement provider and its associated terms and conditions by posting this information within the Services; however, you acknowledge that a service provider’s terms and conditions may change from time to time, and that it is your responsibility to check the terms and conditions of GPT-4 and our other identified service providers regularly to ensure continued compliance.</DocItem>

          <DocHeader>REQUIRED TRANSFERS</DocHeader>
          <DocItem>We may also transfer your Personal Information to third parties under the following circumstances: (i) to comply with a legal requirement, law, subpoena, judicial proceeding, court order, governmental request, or legal process; (ii) to investigate a possible crime, such as fraud or identity theft; (iii) when we believe it is necessary to protect the rights, property, or safety of paraplanner.ai or other persons, or (iv) as otherwise required or permitted by law, including any contractual obligations of paraplanner.ai.</DocItem>
          <DocHeader>AS DIRECTED BY YOU AND WITH YOUR CONSENT</DocHeader>
          <DocItem>We also share Personal Information with companies, agencies, organizations or individuals outside of paraplanner.ai at your direction or when we have your consent to do so.</DocItem>
          <DocHeader>HOW DO WE PROTECT YOUR INFORMATION</DocHeader>
          <DocItem>We take the security of your Personal Information very seriously.  We use reasonable administrative, physical, and technical safeguards to secure the Personal Information you share with us.  Despite these safeguards and our additional efforts to secure your information, we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your Personal Information.</DocItem>
          <DocHeader>THIRD-PARTY WEBSITES</DocHeader>
          <DocItem>The Services may contain hyperlinks to websites operated by third parties, which may include social media features, such as social media buttons or links.  We provide such hyperlinks for your reference and convenience only.  We do not control such websites and are not responsible for their content or the privacy or other practices of such websites.  It is up to you to read and fully understand their privacy policies.  Our inclusion of hyperlinks to such websites does not imply any endorsement of the material on such websites.  If you are submitting information to any such third party, you should review and understand that party’s applicable policies, including their privacy policies, before providing your information to the third-party.</DocItem>
          <DocHeader>INTERNATIONAL VISITORS</DocHeader>
          <DocItem>Our Services are hosted in the United States.  If you use our Services from the United Kingdom, European Union or other regions of the world with laws governing data collection and use that may differ from the laws of the United States, then please note that by sending an email or other communication containing Personal Information or by providing Personal Information through our Services, you are assuming the risk of doing so and are voluntarily transferring your Personal Information outside of those regions to the United States and other countries.</DocItem>

          <DocHeader>OPT OUT</DocHeader>
          <DocItem>If you no longer wish to receive our marketing and promotional communications, you may opt out by following the instructions included in each communication.</DocItem>
          <DocHeader>CHILDREN'S PRIVACY</DocHeader>
          <DocItem>Our Services are not intended for use by children under the age of 13 and we do not knowingly collect Personal Information from children under the age of 13 in connection with the Services.</DocItem>
          <DocItem>To the extent that any Provided Data includes information about children under the age of 18, paraplanner.ai will only collect, transmit, store and process such information in connection with providing Services to you.</DocItem>
          <DocHeader>CHANGES TO OUR PRIVACY POLICY</DocHeader>
          <DocItem>We reserve the right to amend this Privacy Policy at any time without any prior notice to you.  Each time you use our Services the current version of this Privacy Policy will apply.  When you use our Services, we encourage you to check the dates of the Privacy Policy and review any changes since the last version.</DocItem>
          <DocHeader>QUESTIONS</DocHeader>
          <DocItem>If you have any questions about this Privacy Policy, or our privacy practices, please contact us at <a href="mailto:hello@paraplanner.ai">hello@paraplanner.ai</a>.</DocItem>
