    ...
    <>
      ...
      <SectionContainer withoutAnimation={true}>
        <Stack>
          ...
          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>
          ...
          <p>The responses to your questions and commands provided by the AI Assistant and Admin Personnel are paraplanner.ai Content and all intellectual property and other rights relating to the AI Assistant and Admin Personnel are solely and exclusively owned by paraplanner.ai, except for proprietary information about you and your business, which is owned exclusively by you.  The AI Assistant is designed, and our Admin Personnel are trained, to be responsive to your questions and sensitive to information you provide to the AI Assistant, your Provided Data, and to other information available to paraplanner.ai.  Your interactions with our AI Assistant and Admin Personnel may be recorded and shared with our service providers that support our AI Assistant or for other business purposes.</p>
          <p>The AI Assistant and our Admin Personnel do not intend, and cannot, recommend the purchase or sale of specific securities or investment assets.  While the AI Assistant and our Admin Personnel may offer informational or educational information, they will not discern what investment choices would be suitable for any individual’s financial situation.  Responses and information from the AI Assistant and our Admin Personnel are general in nature and should not be considered investment, legal, or tax advice.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>
            Third Party Content
          </Typography>
          <p>The Services may contain proprietary information and materials licensed or provided to paraplanner.ai by third parties in connection with paraplanner.ai’s provision of the Services and/or other business purposes (collectively, “Third Party Content”).  Third Party Content is the copyrighted work of its owner, who expressly retains all right, title and interest in and to the Third Party Content, including, without limitation, all intellectual property rights therein and thereto.</p>
          <p>All statements and/or opinions expressed in the Third Party Content are solely the opinions and the responsibility of the person or entity providing those materials. These materials do not necessarily reflect the opinion of paraplanner.ai.  We are not responsible, or liable to you or any third party, for the content or accuracy of any materials provided by any third parties.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>No Reliance</Typography>
          <p>Any reliance you place on the Services, Provided Data, paraplanner.ai Content and/or Third Party Content is strictly at your own risk. We disclaim all liability and responsibility arising from any reliance placed on such materials by you or by anyone who may be informed of or exposed to such materials.   PARAPLANNER.AI DOES NOT INTEND TO PROVIDE YOU WITH ANY LEGAL, TAX, OR FINANCIAL ADVICE THROUGH THE SERVICES.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Disclaimers</Typography>
          <p>PARAPLANNER.AI MAKES NO REPRESENTATIONS, WARRANTIES OR GUARANTEES, EXPRESS OR IMPLIED, REGARDING THE ACCURACY, ADEQUACY, TIMELINESS, RELIABILITY, COMPLETENESS, OR USEFULNESS OF ANY OF THE INFORMATION IN PARAPLANNER.AI CONTENT OR THE SERVICES, AND EXPRESSLY DISCLAIMS ANY WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, OR TITLE. PARAPLANNER.AI MAKES NO REPRESENTATION, WARRANTY, OR GUARANTEE THAT THE PARAPLANNER.AI CONTENT OR THE SERVICES ARE FREE OF VIRUSES, BUGS, DEFECTS, ERRORS, OR OTHER HARMFUL CODE, OR PROGRAMS INTENDED TO INTERCEPT OR ACQUIRE DATA.</p>
          <p>YOU ACKNOWLEDGE AND UNDERSTAND THAT PROVIDED DATA AVAILABLE TO YOU THROUGH THE SERVICES WILL BE THE MOST RECENT DATA WE HAVE AVAILABLE FROM DATA SOURCES, AND THAT THIS INFORMATION MAY NOT REFLECT PENDING TRANSACTIONS AND OTHER RECENT ACTIVITY.  WE MAKE OR GIVE NO REPRESENTATION OR WARRANTY AS TO THE ACCURACY, COMPLETENESS, CURRENCY, CORRECTNESS, RELIABILITY, INTEGRITY, QUALITY, OR FITNESS FOR PURPOSE OF ANY OF THE PROVIDED DATA MADE AVAILABLE THROUGH THE SERVICES AND, TO THE FULLEST EXTENT PERMITTED BY LAW, ALL IMPLIED WARRANTIES, CONDITIONS OR OTHER TERMS OF ANY KIND ARE HEREBY EXCLUDED AND WE ACCEPT NO LIABILITY FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF YOU OR ANYONE ELSE RELYING ON PROVIDED DATA MADE AVAILABLE THROUGH THE SERVICES.</p>
          <p>Please note, the ability to exclude warranties varies in different jurisdictions. To the extent that a jurisdiction places limits on the ability for a party to exclude warranties, these exclusions exist to the extent permitted by law. Because of this jurisdictional variance, some of the above exclusions may not apply to you.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Social Media</Typography>
          <p>When we make available certain social media features through LinkedIn, X, or other social media sites, you may take such actions as are enabled by those features.  Please be aware that activities on our social media sites, or facilitated by or through our social media sites, are subject to the terms and conditions of the applicable social media site(s).  Any information or content provided to social media sites may be processed and used by the applicable social media sites in accordance with their policies and any agreements with paraplanner.ai.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Links to Other Sites</Typography>
          <p>Our Services may contain links to other websites.  The fact that we link to a website is not an endorsement, authorization or representation of our affiliation with that third party.  We do not exercise control over third party websites.  These other websites may place their own cookies or other files on your computer, collect data, or solicit personal information from you. Other sites follow different rules regarding the use or disclosure of the personal information you submit to them.  We encourage you to read the privacy policies and terms of use for the other websites you visit.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Ownership</Typography>
          ...
          <p>In any arbitration arising out of or related to this Agreement, the arbitrator shall award to the prevailing party, if any, the costs and attorneys’ fees reasonably incurred by the prevailing party in connection with the arbitration.  If the arbitrator determines a party to be the prevailing party under circumstances where the prevailing party won on some but not all of the claims and counterclaims, the arbitrator may award the prevailing party an appropriate percentage of the costs and attorneys’ fees reasonably incurred by the prevailing party in connection with the arbitration.</p>
          <p>YOU AND PARAPLANNER.AI AGREE THAT EACH OF US MAY BRING CLAIMS AGAINST THE OTHER ONLY IN AN INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING.  Further, if the parties’ dispute is resolved through arbitration, the arbitrator may not consolidate another person’s claims with your claims and may not otherwise preside over any form of a representative or class proceeding.</p>
          <p>YOU AND PARAPLANNER.AI EACH HEREBY WAIVE THE RIGHT TO A TRIAL BY JURY FOR DISPUTES ARISING OUT OF OR RELATED TO THIS AGREEMENT, AND THIS WAIVER APPLIES REGARDLESS OF THE TYPE OF DISPUTE, WHETHER PROCEEDING UNDER CLAIMS OF CONTRACT OR TORT (INCLUDING WITHOUT LIMITATION NEGLIGENCE) OR ANY OTHER THEORY.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Force Majeure</Typography>
          <p>You agree that paraplanner.ai is not responsible to you for anything that we may otherwise be responsible for, if it is the result of events beyond our control, including, but not limited to, acts of God, war, insurrection, riots, terrorism, crime, pandemics and epidemics, labor shortages (including lawful and unlawful strikes), embargoes, postal disruption, communication disruption, failure or shortage of infrastructure, shortage of materials, or any other event beyond our control.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Governing Law and Venue</Typography>
          <p>This Agreement shall be governed by the laws of the State of Delaware, United States of America, without regard to its rules on conflicts or choice of law. The United Nations Convention on Contracts for the International Sale of Goods shall not apply to this Agreement.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>General Terms</Typography>
          <p>This Agreement, together with the Privacy Policy, constitute the sole agreements between you and paraplanner.ai for your use and the provision of the Services, and the subject matter hereof. The section titles in this Agreement are for convenience only and have no legal or contractual effect.  Should any provision of this Agreement be held invalid or unenforceable, such provision will be modified to the extent necessary to render it enforceable without losing its intent or severed from this Agreement if no such modification is possible, and other provisions of this Agreement will remain in full force and effect. A waiver by either party of any term or condition of this Agreement or any breach thereof, in any one instance, will not waive such term or condition or any subsequent breach thereof. This Agreement and any rights and licenses granted hereunder, may not be transferred, delegated or assigned by you, but may be assigned, delegated or transferred by paraplanner.ai without restriction. Any attempted assignment, subcontract, delegation or transfer by you in violation of the foregoing will be null and void. This Agreement shall be binding upon and inure to the benefit of each of the parties and the parties’ respective successors and permitted assigns. Certain of our licensors and suppliers may be third-party beneficiaries of this Agreement and have the right to enforce this Agreement against you.</p>

          <Typography variant="body1" sx={{ marginTop: 4, marginBottom: 1, textDecoration: 'underline' }}>Contact Information</Typography>
          <p>If you have any questions about the Services or this Agreement, please contact us at <a href="mailto:hello@paraplanner.ai">hello@paraplanner.ai</a>.</p>
        </Stack >
      </SectionContainer >
    </>
  );
